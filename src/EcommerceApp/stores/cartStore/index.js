...
class CartStore {
   ...
   onClickAddToCart(item) {
      ...
      let FindObject = this.cartProductList.find(
         each => item.productId === each.productId
      )
   ...
   clearCart() {
      const a = window.confirm('Would you like to confirm')
      if (a) {
         alert(
            'Thank you for shopping with us 😊.Your products will be delivered in 3 days to the address mentioned in your profile'
         )
         this.init()
      }
   }
